...
@Service("grepForumContentService")
public class GrepForumContentService {
	...
	static String UWANTS_DVD = "http://www.uwants.com/forumdisplay.php?fid=231&page=%d";
	static String TVBOXNOW_MOVIE = "http://www.tvboxnow.com/forum-329-%d.html";
	...
	static {
		...
		typeToURLlistMap.put(ContentType.MOVIE, new String[] {UWANTS_DVD, TVBOXNOW_MOVIE});
		...
		urlToParserClassMap.put(TVBOXNOW_MOVIE, TvboxnowContentParser.class);
	}
