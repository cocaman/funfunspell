...
public class DictationManageService implements IDictationManageService {
	...
	public DictationSummary getDictationSummary(Member member) {
		...
		DictationSummary summary = new DictationSummary();
		summary.setDictationCreated(dictationDAO.getTotalDictationByMember(member));
		summary.setTotalAttempted(dictationDAO.getTotalAttemptedByMember(member));
		summary.setMostAttemptedDictation(dictationDAO.getMostAttemptedByMember(member));
		summary.setHighestRatingDictation(dictationDAO.getHighestRatingByMember(member));
		summary.setLastHistory(dictationHistoryDAO.getLastestOfAllDictationByMember(member));
